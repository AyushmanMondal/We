const POSTS = [
  // TEMPLATE — copy, fill in, paste above this line, newest first
  // {
  //   id:      'post-slug',
  //   title:   'Post Title',
  //   date:    '2025-09-03',
  //   tag:     'Update',
  //   summary: 'One sentence for the feed card.',
  //   body: [
  //     { type:'text',    value:'Paragraph.' },
  //     { type:'heading', value:'Subheading' },
  //     { type:'divider' },
  //     { type:'image',   url:'https://...', caption:'Optional' },
  //     { type:'video',   url:'https://www.youtube.com/watch?v=...' },
  //     { type:'link',    url:'https://...', label:'Button label' },
  //   ]
  // },
